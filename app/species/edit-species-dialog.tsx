...
export default function EditSpeciesDialog({ species, open, onOpenChange }: EditSpeciesDialogProps) {
  ...
  // Set default values for the form (on open) to the existing species data which was passed in as a prop
  ...
  // Reset form when dialog opens or species changes
  useEffect(() => {
    if (open) {
      form.reset({
        scientific_name: species.scientific_name,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-screen overflow-y-auto sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Edit the species information here. Click &quot;Update Species&quot; below when you&apos;re done.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
